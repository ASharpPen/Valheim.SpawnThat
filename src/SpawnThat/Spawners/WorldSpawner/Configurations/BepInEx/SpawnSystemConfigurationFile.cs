...
internal class SpawnConfiguration : TomlConfigWithSubsections<TomlConfig>
{
    ...
    public TomlConfigEntry<string> TemplateId = new("Template", "", "Technical setting intended for cross-mod identification of mobs spawned by this template. Sets a custom identifier which will be assigned to the spawned mobs ZDO as 'ZDO.Set(\"spawn_template_id\", TemplateIdentifier)'.");
    ...
    public TomlConfigEntry<List<string>> Biomes = new("Biomes", new(), "Biomes in which entity can spawn. Leave empty for all.");
...
internal class SpawnSystemConfigEpicLoot : TomlConfig
{
    ...
    public TomlConfigEntry<List<string>> ConditionNearbyPlayerCarryItemWithRarity = new("ConditionNearbyPlayerCarryItemWithRarity", new(), "Checks if nearby players have any items of the listed rarities.\nEg. Magic, Legendary");
