...
internal static class SpawnDataFileDumper
{
    ...
    {
        lines.Add($"# This file was auto-generated by Spawn That {SpawnThatPlugin.Version} at {DateTimeOffset.UtcNow.ToString("u")}, with Valheim '{Version.m_major}.{Version.m_minor}.{Version.m_patch}'.");
        ...
        lines.Add($"# Be aware, for entries added by mods using the Spawn That API, it might not be showing the full truth since the API can do a lot more than the config file allows.");
        lines.Add($"");
    }
